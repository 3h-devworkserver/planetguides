...
class PermissionTableSeeder extends Seeder {
	...
	public function run() {
		...
		$permission_model = config('access.permission');
		$viewAccessManagement = new $permission_model;
		$viewAccessManagement->name = 'view-page-management';
		$viewAccessManagement->display_name = 'View Page Management';
		$viewAccessManagement->system = true;
		$viewAccessManagement->group_id = 1;
		...
		**/
		...
		$permission_model = config('access.permission');
		$createUsers = new $permission_model;
		$createUsers->name = 'create-pages';
		$createUsers->display_name = 'Create Pages';
		$createUsers->system = true;
		$createUsers->group_id = 5;
		$createUsers->sort = 1;
		$createUsers->created_at = Carbon::now();
		$createUsers->updated_at = Carbon::now();
		$createUsers->save();
		...
		$permission_model = config('access.permission');
		$editUsers = new $permission_model;
		$editUsers->name = 'edit-pages';
		$editUsers->display_name = 'Edit Pages';
		$editUsers->system = true;
		$editUsers->group_id = 5;
		$editUsers->sort = 2;
		$editUsers->created_at = Carbon::now();
		$editUsers->updated_at = Carbon::now();
		$editUsers->save();
		...
		$permission_model = config('access.permission');
		$deleteUsers = new $permission_model;
		$deleteUsers->name = 'delete-pages';
		$deleteUsers->display_name = 'Delete Pages';
		$deleteUsers->system = true;
		$deleteUsers->group_id = 5;
		$deleteUsers->sort = 3;
		$deleteUsers->created_at = Carbon::now();
		$deleteUsers->updated_at = Carbon::now();
		$deleteUsers->save();
