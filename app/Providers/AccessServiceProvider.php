...
class AccessServiceProvider extends ServiceProvider
{
	...
	public function registerBindings() {
		...
		$this->app->bind(
			\App\Repositories\Backend\Pages\PageContract::class,
			\App\Repositories\Backend\Pages\EloquentPageRepository::class
		);

		$this->app->bind(
			\App\Repositories\Backend\Dashboard\DashboardContract::class,
			\App\Repositories\Backend\Dashboard\EloquentDashboardRepository::class
		);
	}
