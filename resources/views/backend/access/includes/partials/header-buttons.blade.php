    ...
    <!-- <div> 
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="active">{!! link_to_route('admin.access.users.create', trans('menus.create_user')) !!}</li>
                <li role="presentation" class="active">{!! link_to_route('admin.access.roles.create', trans('menus.create_role')) !!}</li>


                <li role="presentation" class="active">{!! link_to_route('admin.access.roles.permissions.index', trans('menus.permission_management')) !!}</li>
                <li role="presentation" class="active">{!! link_to_route('admin.access.roles.index', trans('menus.header_buttons.roles.all')) !!}</li>
            </ul>
    </div> -->