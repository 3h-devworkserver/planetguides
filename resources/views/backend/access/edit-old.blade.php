  ...
  <div class="col-md-3">
    ...
    <div class="box box-primary">
      <div class="box-body box-profile">
        <img class="profile-user-img img-responsive img-circle profile-avatar" src="{{ asset($user->profile->profilesmallImg) }}" alt="User profile picture">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <select class="chosen-select form-control" multiple="multiple" name="OtherGuidingArea[]" id="places">
                                                @foreach($guidearea as $place)
                                                    <option value="{{$place->id}}" @foreach($selectedoarea as $p)
                                   ...
                                   <div id="onchangehide" style=" ">
                                    ...
                                    <select class="chosen-select form-control" multiple="multiple" name="language[]" id="places">
                                                ...
                                                @foreach($guidelanguage as $places)
                                                    <option value="{{$places->id}}" @foreach($selectedlang as  $p) @if($places->id === $p[0]->id) selected="selected"@endif @endforeach>{{$places->language}}</option>
                                                @endforeach
                                            </select>                       
